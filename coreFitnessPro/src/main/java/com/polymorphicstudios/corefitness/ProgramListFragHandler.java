...
import com.polymorphicstudios.fragment.ProgramListFragment;
...
public class ProgramListFragHandler extends SherlockFragmentActivity{
	private String[] TAB_TITLES = new String[] { "Level 1", "Level 2", "Level 3"};
	 ...
	 //Create bundle for alert dialog
	 ...
	 protected void onCreate(Bundle savedInstanceState) {
			...
			com.actionbarsherlock.app.ActionBar actionBar = getSupportActionBar();
		 	...
		 	actionBar.setTitle(Html.fromHtml("<font color='#ffffff'>program list</font>"));
	        ...
	        for(int i = 0; i < TAB_TITLES.length; i++)
	        {
	        	...
	        	bundle_args.putInt("LEVEL_NUMBER",  i+1);
	        	bundle_args.putInt("SCREEN_HEIGHT", dm.heightPixels);
	        	bundle_args.putInt("SCREEN_WIDTH", dm.widthPixels);
	        	frag = Fragment.instantiate(this, ProgramListFragment.class.getName());
    ...
    public void onBackPressed() {
	 ...
	 {       
	      if(menuItem.getItemId() == android.R.id.home)
	      {
	 	   ...
	 	   {
	    	   	  CustomDialog.createCustomDialog(getString(R.string.program_help_text),"Programs Info", R.drawable.pursefitnesslogo,fm);
	 	   }
